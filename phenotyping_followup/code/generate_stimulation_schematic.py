...
<<<<<<< HEAD:phenotyping_followup/code/generate_stimulation_schematic.py
# Cinnamoroll color palette
import sys
from pathlib import Path
sys.path.insert(0, str(Path(__file__).parent))
from cinnamoroll_palette import COLORS
RED = COLORS['failure_dark']
RED_FILL = COLORS['failure']
GRAY = COLORS['text_light']
=======
# Colors
RED = '#DC2626'
RED_FILL = '#FEE2E2'
GRAY = '#6B7280'
>>>>>>> 300694426984e06c404a7f98f9992b80ce815cc0:phenotyping_followup/code_for_sharing/generate_stimulation_schematic.py
...
for ax_idx, (ax, (title, led_func, stats)) in enumerate(zip(axes, designs)):
    ...
    # Note below signal
<<<<<<< HEAD:phenotyping_followup/code/generate_stimulation_schematic.py
    note_color = COLORS['recommended'] if 'Recommended' in title else COLORS['text_light']
=======
