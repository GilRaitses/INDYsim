#!/bin/bash
# Double-clickable script to run phenotyping analysis pipeline (v2 with turn rate fix)
...
python3 -c "import tqdm" 2>/dev/null || {
    ...
    pip install tqdm --quiet 2>/dev/null || echo "Could not install tqdm, continuing..."
}

# Run the analysis pipeline
echo "=========================================="
echo "Phenotyping Analysis Pipeline v2"
echo "=========================================="
echo ""
echo "This will:"
echo "  1. Load simulated tracks"
echo "  2. Fit track-level kernels"
echo "  3. Extract phenotype features (FIXED turn rate calculation)"
...
echo "=========================================="
echo ""
echo "Results saved to: $INDYSIM_DIR/results/phenotyping_analysis_v2/"
echo ""
