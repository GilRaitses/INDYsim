...
- **Sample Size**: 40+ larvae per condition, multiple replications per experimental condition
...
Traditional approaches use simple rate averages or linear regressions. This project develops a <span class=\"tech\">structured hazard model</span> that captures temporal dependencies and supports trajectory simulation.
...
- Run 30 simulation replications (each representing one larva)
- Record events and compute KPIs per replication
- Generate <span class=\"tech\">AcrossReplicationsSummary.csv</span> with means and confidence intervals
