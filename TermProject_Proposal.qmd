...
This creates three output files: event records with 50ms time bins, full trajectory data aligned with stimulus, and summary statistics in CSV and JSON formats.
