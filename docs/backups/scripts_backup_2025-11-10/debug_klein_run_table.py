...
def debug_klein_requirements(h5_file_path: str, track_key: str = None):
    ...
    try:
        ...
        print(f"FAIL ERROR extracting trajectory features: {e}")
        import traceback
        traceback.print_exc()
        return
    ...
    if hasattr(df, 'attrs') and 'klein_run_table' in df.attrs:
        ...
        print("FAIL Klein run table NOT found in df.attrs")
    ...
    try:
        ...
        try:
            ...
            print(f"FAIL ERROR generating Klein run table: {e}")
            import traceback
            traceback.print_exc()
        
    except Exception as e:
        print(f"FAIL ERROR running MAGAT segmentation: {e}")
        import traceback
        traceback.print_exc()
