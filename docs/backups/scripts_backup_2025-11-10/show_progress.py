    ...
    try:
        while True:
            ...
            if n_complete is not None:
                ...
                if latest_file:
                    ...
                    if age_seconds is not None:
                        if age_seconds < 30:
                            ...
                            print(f"Status: WARNING Slow ({age_seconds:.1f}s ago)")
                        else:
                            print(f"Status: FAIL Stalled ({age_seconds:.1f}s ago)")
                    print()
                ...
                print("WARNING No progress files found yet")
            ...
            try:
                ...
                if processes:
                    ...
                    if n_complete and n_complete < total:
                        print("FAIL Process appears to have stopped!")
                    else:
