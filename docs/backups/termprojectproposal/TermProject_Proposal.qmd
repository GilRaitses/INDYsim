...
\subsubsection*{Core Model Equations}

\textbf{Equation \ref{eq:hazard}: Hazard Rate Model}
...
\textbf{Equation \ref{eq:kernel}: Temporal Kernel Basis Expansion}
...
\textbf{Equation \ref{eq:likelihood}: Event Likelihood}
...
\textbf{Equation \ref{eq:estimation}: Penalized Maximum Likelihood Estimation}
...
\textbf{Equation \ref{eq:speed_dynamics}: Position Integration}
...
\textbf{Equation \ref{eq:run_length}: Replication Count Determination}
...
\textbf{Equation \ref{eq:mean}: Sample Mean}
...
\textbf{Equation \ref{eq:std}: Sample Standard Deviation}
...
\textbf{Equation \ref{eq:ci}: 95\% Confidence Interval}
...
\textbf{Code \ref{code-h5-extract}: H5 Data Extraction Command}
...
\textbf{Code \ref{code-feature-engineering}: Feature Engineering Pipeline}
...
\textbf{Code \ref{code-simulator}: Trajectory Simulator Class}
...
\textbf{Code \ref{code-doe-execution}: Design of Experiments Execution Loop}
