#!/usr/bin/env python3
"""
Run NB-GLM Hazard Model Pipeline

Loads binned data, fits hazard model with cluster-robust SEs,
...
def main():
    parser = argparse.ArgumentParser(description='Run hazard model pipeline')
