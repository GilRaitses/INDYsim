#!/usr/bin/env python3
"""
Prepare Binned Data for NB-GLM Hazard Model

Transforms frame-level trajectory/event data into binned format suitable for
Negative Binomial GLM hazard modeling.
...
def main():
    parser = argparse.ArgumentParser(description='Prepare binned data for NB-GLM hazard model')
